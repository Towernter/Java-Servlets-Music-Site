...
<html>
  ...
  <li class="nav1"><a class="active" href="logged.jsp">All</a></li>
...
<blockquote style="font-size: 20px;"><strong>LOGGED IN AS: &nbsp;&nbsp;&nbsp;<% out.print(Catch.name.toUpperCase());%> </strong>&nbsp;&nbsp;&nbsp; </blockquote>
          ...
          <form action="Searchlike" method="POST">
...
<div id="wrap">
        ...
        <div class="left" >
            <h4 style="padding-left: 10%;">RESULTS FOR SEARCH &nbsp;'<% out.print(request.getParameter("search")); %>':</h4>
...
ps=conn.prepareStatement("select * from songs"); 
       rs=ps.executeQuery();
       while(rs.next()){
           if(rs.getString("song").toLowerCase().contains(request.getParameter("search").toLowerCase().trim())){
    %>
