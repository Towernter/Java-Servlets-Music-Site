...
<html>
  ...
  <li class="nav1"><a class="active" href="zimdancehall.jsp">Zim-Dancehall</a></li>
...
<blockquote style="font-size: 20px;"><strong>LOGGED IN AS: &nbsp;&nbsp;&nbsp;<% out.print(Catch.name.toUpperCase());%> </strong>&nbsp;&nbsp;&nbsp; </blockquote>
          ...
          <form action="Zimlike" method="POST">
...
<div id="wrap">
        ...
        <div class="left" >
            <h4 style="padding-left: 10%;">RESULTS FOR SEARCH &nbsp;'zim-dancehall':</h4>
...
ps=conn.prepareStatement("select * from songs"); 
       rs=ps.executeQuery();
       while(rs.next()){
           if(rs.getString("genre").toLowerCase().contains("zim-dancehall")){
    %>
